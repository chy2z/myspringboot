...
* @date 2018/4/12 8:40 
*/
public class ZkWatchUtil implements Watcher {

    public static final Logger LOG = LoggerFactory.getLogger(ZkWatchUtil.class);
    ...
    public static void main(String [] args){
        ...
        ZkWatchUtil zkWatchAPI = new ZkWatchUtil();
